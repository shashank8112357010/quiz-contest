...
const Quiz = () => {
  ...
  }, [categoryId, parsedDay, user?.uid, startBackgroundMusic, stopBackgroundMusic, questions.length]);
  ...
  const restartQuiz = async () => {
    ...
    // Fetch 10 questions for the selected category, or "gk" if none selected
        const categoryQuestions = getRandomQuestions(categoryId || "gk", 10, user?.uid);
    setQuestions(categoryQuestions);
