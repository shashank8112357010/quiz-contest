...
const Quiz = () => {
  ...
  useEffect(() => {
    // Check daily limit before loading questions
    if (!canPlayQuiz()) {
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="bg-white/10 border-white/20 text-white hover:bg-white/20 text-xs px-3 py-1 h-auto"
                    onClick={goToCategories}
                  >
                    {t("changeCategory")}
                  </Button>
              ...
              <div className="flex items-center gap-4">
                <div className="text-white/70 text-sm text-right">
                  <div className="font-bold text-white">
                    {currentQuestion + 1} {t("played")} /{" "}
                    {category?.questionCount || 100}
                  </div>
                  <div className="text-xs">{t("questionsInBank")}</div>
                </div>
