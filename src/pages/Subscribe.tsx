...
const STRIPE_PUBLISHABLE_KEY = import.meta.env.VITE_STRIPE_PUBLISHABLE_KEY || "pk_test_123";

const stripePromise = loadStripe(STRIPE_PUBLISHABLE_KEY);

const SUBSCRIPTION_PRICE_ID = import.meta.env.VITE_STRIPE_PRICE_ID || "price_123";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Card className="max-w-lg w-full bg-slate-800/80 border-slate-700">
        <CardHeader>
          <CardTitle className="text-white text-2xl">Subscribe for 90-Day Season</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <Button className="w-full bg-purple-600 hover:bg-purple-700" onClick={handleSubscribe}>
            Subscribe Now
          </Button>
        </CardContent>
      </Card>
