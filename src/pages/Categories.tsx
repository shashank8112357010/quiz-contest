...
export const categories: QuizCategory[] = [
  ...
  },
  {
    id: "history",
    name: "History",
    description: "Past events, civilizations, and historical facts",
    icon: History,
  ...
  },
  {
    id: "celebrity",
    name: "Celebrity",
    description: "Famous personalities, movies, and entertainment",
    icon: Star,
  ...
  },
  {
    id: "cricket",
    name: "Cricket",
    description: "The gentleman's game, rules, and cricket legends",
    icon: Target,
  ...
  },
  {
    id: "banking",
    name: "Banking",
    description: "Financial services, economics, and banking knowledge",
    icon: Banknote,
  ...
  },
  {
    id: "sports",
    name: "Sports",
    description: "Athletics, games, and sporting achievements",
    icon: Dumbbell,
  ...
  },
  {
    id: "geography",
    name: "Geography",
    description: "Earth's features, countries, and geographical facts",
    icon: MapPin,
  ...
  },
  {
    id: "biology",
    name: "Biology",
    description: "Life sciences, organisms, and biological processes",
    icon: HeartPulse,
  ...
  },
  {
    id: "chemistry",
    name: "Chemistry",
    description: "Chemical elements, reactions, and molecular science",
    icon: TestTube,
  ...
  },
  {
    id: "physics",
    name: "Physics",
    description: "Physical laws, forces, and scientific principles",
    icon: ZapIcon,
  ...
  },
  {
    ...
    description: "Classic works, authors, and literary analysis",
    icon: BookText,
  ...
  {
    id: "brand",
    name: "Brands & Marketing",
    description: "Famous brands, logos, and marketing knowledge",
    icon: Award,
  ...
  },
  {
    id: "psychology",
    name: "Psychology",
    description: "Human behavior, mental processes, and psychology",
    icon: Brain,
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-40">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          {/* Categories Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 max-w-7xl mx-auto px-2 sm:px-0">
